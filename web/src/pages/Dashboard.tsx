...
type HomeResourceData = { decks: Deck[], note_types: NoteType[], card_templates: CardTemplate[], notes: Note[], cards: Card[] }

export default function Dashboard() {
  const { user } = useAuth();
  const navigate = useNavigate();
  const [data] = createResource<HomeResourceData>(getDashboard);
